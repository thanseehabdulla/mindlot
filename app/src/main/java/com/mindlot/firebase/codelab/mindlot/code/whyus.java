 ...
 */
public class whyus extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mindlot.firebase.codelab.mindlot.R.layout.whyus_mains);
    ...
    class CustomGestureDetector extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            // Swipe left (next)
            if (e1.getX() > e2.getX()) {
                mViewFlipper.setInAnimation(whyus.this, com.mindlot.firebase.codelab.mindlot.R.anim.left_in);
                mViewFlipper.setOutAnimation(whyus.this, com.mindlot.firebase.codelab.mindlot.R.anim.left_out);
            ...
            if (e1.getX() < e2.getX()) {
                mViewFlipper.setInAnimation(whyus.this, com.mindlot.firebase.codelab.mindlot.R.anim.right_in);
                mViewFlipper.setOutAnimation(whyus.this, com.mindlot.firebase.codelab.mindlot.R.anim.right_out);
