 ...
 */
public class whyyou extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.mindlot.firebase.codelab.mindlot.R.layout.whyyou_mains);
    ...
    class CustomGestureDetector extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            // Swipe left (next)
            if (e1.getX() > e2.getX()) {
                mViewFlipper.setInAnimation(whyyou.this, com.mindlot.firebase.codelab.mindlot.R.anim.left_in);
                mViewFlipper.setOutAnimation(whyyou.this, com.mindlot.firebase.codelab.mindlot.R.anim.left_out);
            ...
            if (e1.getX() < e2.getX()) {
                mViewFlipper.setInAnimation(whyyou.this, com.mindlot.firebase.codelab.mindlot.R.anim.right_in);
                mViewFlipper.setOutAnimation(whyyou.this, com.mindlot.firebase.codelab.mindlot.R.anim.right_out);
